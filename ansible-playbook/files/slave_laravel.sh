...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=gbenga/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=gbenga/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=password@123/' /var/www/html/laravel/.env
